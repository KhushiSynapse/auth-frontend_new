 ...
 useEffect(() => {
  ...
  <div className="min-h-screen bg-gray-50 px-4 py-6">
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      ...
      {list.map((product, index) => (
        ...
        >
          ...
          {/* Price */}
          <div className="flex justify-between md:justify-center text-gray-700">
    ...
    <div className="max-w-4xl mx-auto mt-8 flex flex-col items-center">
      ...
      <div
        id="paypal-button"
        className="w-full max-w-sm mt-4 p-4 bg-white rounded-lg shadow-md flex justify-center"
      ></div>
    </div>
  </div>
)}

  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-6 flex flex-col gap-8">
      ...
      <div className="max-w-4xl w-full mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        {/* Product Row */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4 border-b py-2 text-gray-700 items-center">
          <p className="font-medium">{name}</p>
          <p className="text-center">${price}</p>
          <p className="text-center">{quantity}</p>
          <p className="text-right">${Number(price) * quantity}</p>
        </div>
        ...
        <div className="mt-6 flex flex-col items-center md:items-end gap-2">
          ...
          <button className="mt-4 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Pay
          </button>
        </div>
      </div>
